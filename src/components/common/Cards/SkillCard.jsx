...
const SkillCard = ({ icon, text }) => {
    return (
        ...
        <div className="md:aspect-square flex flex-col items-center justify-center gap-3 md:gap-4 px-5 py-4 md:p-5 rounded-xl bg-transparent border border-neon/50 hover:border-neon hover:shadow-card-hover transition-colors">
